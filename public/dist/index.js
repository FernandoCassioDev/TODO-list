...
(function () {
    ...
    var Reminder = /** @class */ (function () {
        function Reminder(description, date, notifications) {
            ...
            this.notifications = [NotificationPlatform.SMS, NotificationPlatform.EMAIL, NotificationPlatform.PUSH_NOTIFICATION];
    ...
    var todo = new Todo("descrição");
    var reminder = new Reminder("descrição", new Date(), [NotificationPlatform.EMAIL]);
    var taskView = {
        ...
        render: function (tasks, mode) {
            ...
            if (mode === ViewMode.TODO) {
                ...
                reminderSet === null || reminderSet === void 0 ? void 0 : reminderSet.setAttribute("disable", "true");
            }
            else {
                ...
                todoSet === null || todoSet === void 0 ? void 0 : todoSet.setAttribute("disable", "true");
            }
        },
    };
